...
import WordTruncate from '../Helper/WordTruncate'
              ...
              <form onSubmit={submitHandler}>
                <div className="form-control">
                  ...
                  <input
                    ...
                    className="input input-bordered bg-slate-50 text-gray-800"
                    required
                  />
                  {error.nameError && (
                    <label className="label">
              ...
              <div className="card-body bg-blue-500 text-white">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-2xl">
                    <strong>
                      Instructor :{" "}
                      <span className="text-orange-300">{instructor}</span>
                    </strong>
                  </p>
                </div>

                <div>
                  <p>{WordTruncate(courseInfo,10)+'...'}</p>
                </div>
                ...
                <div className="card-actions">
                  ...
                  <div className="badge badge-outline">
                    <AiFillStar className="mr-1 text-yellow-300" /> {ratings}
                  </div>
                </div>
              </div>
            </div>
