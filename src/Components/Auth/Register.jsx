                 ...
                 <form onSubmit={submitHandler}>
                   ...
                   <div className="form-control mt-3 mb-2">
                    ...
                    <div className='flex gap-2'>
                         ...
                         <button onClick={googleLoginHandler} className='py-2 flex items-center'> <p className='ml-2 md:ml-4'>SignUp with <span className='hidden md:inline-block'>Google</span></p> <ImGoogle3 className='ml-2'/> </button>
                         </div>

                         <div className='w-1/2  bg-slate-400 text-center rounded-md text-white hover:bg-slate-500'>
                             <button onClick={githubHandler} className='py-2 flex items-center'> <p className='ml-2 md:ml-4'>SignUp with <span className='hidden md:inline-block'>Github</span></p> <GoMarkGithub className='ml-2'/> </button>
                         </div>
                    </div>
